...
var SingleCategoryPage = /** @class */ (function () {
    function SingleCategoryPage(translate, _storageService, _admobService, appcomponent, alertController, ngzone, platform, _generalService, network, _toastService, _newsService, route, router) {
    ...
    SingleCategoryPage.prototype.doInfinite = function (event) {
        ...
        if (navigator.onLine) {
            ...
            this.translate.get('No internet connection').subscribe(function (res) {
                _this._toastService.toast(res, 'danger');
            });
        }
    };

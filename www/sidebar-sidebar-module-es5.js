        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () { return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ../tour-home/tour-home.module */ "./src/app/tour-home/tour-home.module.ts")).then(function (m) { return m.TourHomePageModule; }); }
                    }
                ]
            }
        ]
...
var SidebarPage = /** @class */ (function () {
    function SidebarPage(homePage, menu, platform, _storageService, _toastService, _categoryService, route) {
    ...
    SidebarPage.prototype.notify = function (catId) {
        ...
        if (!navigator.onLine) {
            ...
            var message = "You need to login first";
            var color = "danger";
            this._toastService.toastFunction(message, color);
        }
        else {

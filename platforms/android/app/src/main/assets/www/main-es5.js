...
var map = {
	"./all-categories/all-categories.module": [
		...
		"default~all-categories-all-categories-module~category-tiles-category-tiles-module~sidebar-sidebar-module",
		"all-categories-all-categories-module"
	],
	...
	"./large-post/large-post.module": [
		...
		"default~large-post-large-post-module~sidebar-sidebar-module~single-category-single-category-module",
		"large-post-large-post-module"
	],
	"./post-tiles/post-tiles.module": [
		"./src/app/post-tiles/post-tiles.module.ts",
		"default~post-tiles-post-tiles-module~sidebar-sidebar-module~single-category-single-category-module",
		"post-tiles-post-tiles-module"
	],
...
/* harmony import */ var _services_news_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./services/news.service */ "./src/app/services/news.service.ts");
/* harmony import */ var _services_general_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./services/general.service */ "./src/app/services/general.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(network, fcm, market, firebaseDynamicLinks, _userService, toastController, platform, splashScreen, statusBar, router, deeplinks, events, _newsService, _storageService, _categoryService, _generalService) {
        var _this = this;
    ...
    AppComponent.ctorParameters = function () { return [
        ...
        { type: _services_news_service__WEBPACK_IMPORTED_MODULE_19__["NewsService"] },
        ...
        { type: _services_general_service__WEBPACK_IMPORTED_MODULE_20__["GeneralService"] }
    ]; };
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_14__["Network"],
            ...
            _services_news_service__WEBPACK_IMPORTED_MODULE_19__["NewsService"],
...
var HomePage = /** @class */ (function () {
    function HomePage(menu, network, _admobService, market, alertController, _generalService, firebaseDynamicLinks, _toastService, _userService, screenOrientation, platform, fcm, _newsService, router, keyboard, _storageService) {
        this.menu = menu;
        this.network = network;
        this._admobService = _admobService;
        this.market = market;
    ...
    HomePage.prototype.ionViewDidEnter = function () {
        ...
        this.platform.ready().then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!!localStorage.getItem('deviceToken')) return [3 /*break*/, 1];
                    ...
                    case 1:
                        // setTimeout(async () => {
                        console.log('this.selected', localStorage.getItem('language'));
                        if (!!localStorage.getItem('accessToken')) return [3 /*break*/, 3];
                        _b = (_a = this._userService).firstTimeUser;
                        return [4 /*yield*/, localStorage.getItem('language')];
                    case 2:
                        _b.apply(_a, [_c.sent()]).subscribe(function (res) {
                        ...
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, localStorage.getItem('accessToken')];
                    case 4:
                        accessToken = _c.sent();
                        return [4 /*yield*/, localStorage.getItem('deviceToken')];
                    case 5:
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.network.type != 'none')) return [3 /*break*/, 1];
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this._storageService.getNewsForOffline()];
                    case 2:
                        newsArrayOffline = _a.sent();
...
var TourHomePage = /** @class */ (function () {
    function TourHomePage(_storageService, storage, _userService, _newsService, router) {
        this._storageService = _storageService;
        this.storage = storage;
        this._userService = _userService;
        this._newsService = _newsService;
    ...
    TourHomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_storage_service__WEBPACK_IMPORTED_MODULE_1__["StorageService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_6__["Storage"], _services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"], _services_news_service__WEBPACK_IMPORTED_MODULE_4__["NewsService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], TourHomePage);
    return TourHomePage;
}());

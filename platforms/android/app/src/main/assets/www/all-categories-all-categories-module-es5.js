...
var AllCategoriesPage = /** @class */ (function () {
    function AllCategoriesPage(storage, _storageService, _admobService, router, platform, appcomponent, _userService, _categoryService) {
    ...
    AllCategoriesPage.prototype.viewEnterFun = function () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        console.log("HELLO");
                        return [4 /*yield*/, this.storage.get('cat')];
                    case 2:
                        catString = _a.sent();

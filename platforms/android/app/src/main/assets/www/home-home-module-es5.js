...
var HomePage = /** @class */ (function () {
    function HomePage(navctrl, sidebar, translate, localNotifications, network, _admobService, market, alertController, _generalService, nav, firebaseDynamicLinks, _toastService, _userService, screenOrientation, platform, fcm, _newsService, router, keyboard, _storageService) {

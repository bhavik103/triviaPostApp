...
var HomePage = /** @class */ (function () {
    function HomePage(_generalService, firebaseDynamicLinks, _toastService, _userService, screenOrientation, platform, fcm, _newsService, _categoryService, router, keyboard) {
    ...
    HomePage.prototype.selectLang = function () {
        ...
        if (this.selected) {
            ...
            var lang_1 = this.selected;
            localStorage.setItem('language', lang_1);
            this._generalService.setExtras(lang_1);
            this.language = lang_1;
                ...
                this.fcm.getToken().then(function (token) {
                    ...
                    setTimeout(function () {
                        if (localStorage.getItem('annonymousNotify')) {
                            _this._userService.firstTimeUser(lang_1).subscribe(function (res) {
                                // this.getCategories();

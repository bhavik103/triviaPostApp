...
const SuperTabsContainerComponent = class {
    ...
    async onTouchMove(ev) {
        ...
        const scrollLeft = Object(_utils_b0b0ce49_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.el);
        const scrollX = Object(_utils_b0b0ce49_js__WEBPACK_IMPORTED_MODULE_1__["a"])(this.el, deltaX);
    ...
    async onTouchEnd(ev) {
        ...
        const coords = Object(_utils_b0b0ce49_js__WEBPACK_IMPORTED_MODULE_1__["p"])(ev);
        const deltaTime = Object(_utils_b0b0ce49_js__WEBPACK_IMPORTED_MODULE_1__["b"])() - this.initialTimestamp;
    ...
    calcSelectedTab() {
        ...
        const scrollX = Math.max(minX, Math.min(maxX, Object(_utils_b0b0ce49_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.el)));

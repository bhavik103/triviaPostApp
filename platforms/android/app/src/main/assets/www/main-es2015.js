...
let AppComponent = class AppComponent {
    constructor(network, fcm, market, firebaseDynamicLinks, _userService, toastController, platform, splashScreen, statusBar, router, deeplinks, events, _newsService, _storageService, _categoryService, _generalService) {
...
let HomePage = class HomePage {
    constructor(menu, network, _admobService, market, alertController, _generalService, firebaseDynamicLinks, _toastService, _userService, screenOrientation, platform, fcm, _newsService, router, keyboard, _storageService) {
        this.menu = menu;
        this.network = network;
        this._admobService = _admobService;
        this.market = market;
    ...
    getAllPost(isFirstLoad, event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.network.type != 'none') {
                ...
                let newsArrayOffline = yield this._storageService.getNewsForOffline();
...
let TourHomePage = class TourHomePage {
    constructor(_storageService, storage, _userService, _newsService, router) {
        this._storageService = _storageService;
        this.storage = storage;
        this._userService = _userService;
        this._newsService = _newsService;

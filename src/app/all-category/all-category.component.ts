...
export class AllCategoryComponent implements OnInit {
	...
	myTitle: string;
	that;
	constructor(private network: Network, public platform: Platform, public toastController: ToastController, public _categoryService: CategoryService, private router: Router) {
		this.getCategories();
		this.categories$;
